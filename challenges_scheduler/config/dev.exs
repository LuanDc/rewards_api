...
config :challenges_scheduler, ChallengesSchedulerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "6wxQQqo1UzKF0qd0N4VNguzoa2O+6kp0Kl2u1jDt2iwvbsJJC53gJAyoeJxKyps5",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:challenges_scheduler, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:challenges_scheduler, ~w(--watch)]}
  ]
...
config :challenges_scheduler, ChallengesSchedulerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/challenges_scheduler_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
