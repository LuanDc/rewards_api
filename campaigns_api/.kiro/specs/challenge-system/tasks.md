...
- [ ] 2. Implement Challenge schema
  - [ ] 2.1 Create Challenge schema
  ...
  - [ ] 2.2 Write unit tests for Challenge schema
  ...
  - [ ] 2.3 Write property test for Challenge schema
    - **Property 2: Challenge Name Validation**
    - **Validates: Requirements 1.2**

- [ ] 3. Implement CampaignChallenge schema
  - [ ] 3.1 Create CampaignChallenge schema
  ...
  - [ ] 3.2 Write unit tests for CampaignChallenge schema
  ...
  - [ ] 3.3 Write property tests for CampaignChallenge schema
...
- [ ] 4. Checkpoint - Ensure schema tests pass
  - Run all schema tests and verify they pass
  - Ask user if questions arise

- [ ] 5. Implement Challenges context - Challenge operations
  - [ ] 5.1 Create Challenges context with list_challenges/1
  ...
  - [ ] 5.5 Implement delete_challenge/1 with association check
    - Accept challenge_id parameter only
    - Get challenge without tenant filter
    - Return {:error, :not_found} if not found
    - Check for campaign associations using has_campaign_associations?/1
    - Return {:error, :has_associations} if associations exist
    - Delete from database if no associations
    - _Requirements: 3.5, 3.6, 8.2, 8.3_
  
  - [ ] 5.6 Write unit tests for Challenge context operations
  ...
  - [ ] 5.7 Write property tests for Challenge context
...
- [ ] 6. Implement Challenges context - CampaignChallenge operations
  - [ ] 6.1 Implement list_campaign_challenges/3
  ...
  - [ ] 6.2 Implement get_campaign_challenge/3
  ...
  - [ ] 6.3 Implement create_campaign_challenge/3
  ...
  - [ ] 6.4 Implement update_campaign_challenge/4
  ...
  - [ ] 6.5 Implement delete_campaign_challenge/3
    - Accept tenant_id, campaign_id, and campaign_challenge_id
    - Get campaign challenge with tenant_id filter
    - Return {:error, :not_found} if not found
  ...
  - [ ] 6.6 Implement helper functions
    - Implement has_campaign_associations?/1 to check for associations
  ...
  - [ ] 6.7 Write unit tests for CampaignChallenge context operations
  ...
  - [ ] 6.8 Write property tests for CampaignChallenge context
...
- [ ] 7. Checkpoint - Ensure context tests pass
  - Run all context tests and verify they pass
  - Ask user if questions arise

- [ ] 8. Implement CampaignChallengeController
  - [ ] 8.1 Create CampaignChallengeController with index action
    ...
    - Call Challenges.list_campaign_challenges/3 with options
    - Return 200 with pagination result JSON
    - _Requirements: 4.3_
  
  - [ ] 9.2 Implement show action
    - Extract tenant_id from conn.assigns.tenant.id
    - Extract campaign_id and id from path params
    - Call Challenges.get_campaign_challenge/3
    - Return 200 with campaign challenge JSON if found
    - Return 404 if not found
    - _Requirements: 4.4_
  
  - [ ] 9.3 Implement create action
    - Extract tenant_id from conn.assigns.tenant.id
    - Extract campaign_id from path params
    - Call Challenges.create_campaign_challenge/3
  ...
  - [ ] 9.4 Implement update action
    - Extract tenant_id from conn.assigns.tenant.id
    - Extract campaign_id and id from path params
    - Call Challenges.update_campaign_challenge/4
    - Return 200 with updated campaign challenge JSON on success
    - Return 404 if not found
    - Return 422 with error details on validation failure
    - _Requirements: 4.5, 4.7_
  
  - [ ] 9.5 Implement delete action
    - Extract tenant_id from conn.assigns.tenant.id
    - Extract campaign_id and id from path params
    - Call Challenges.delete_campaign_challenge/3
    - Return 204 No Content on success
    - Return 404 if not found
    - _Requirements: 4.6, 4.7_
  
  - [ ] 9.6 Add helper functions
  ...
  - [ ] 9.7 Write integration tests for CampaignChallengeController
...
- [ ] 10. Create test data generators
  ...
  - [ ] 10.2 Add StreamData generators
