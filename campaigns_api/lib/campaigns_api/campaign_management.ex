defmodule CampaignsApi.CampaignManagement do
  @moduledoc """
  The CampaignManagement context manages campaign and participant operations with product isolation.

  All operations require product_id parameter to ensure data isolation between products.
  ...
  @doc """
  Gets a single campaign by ID for a specific product.
  """
  ...
  @doc """
  Creates a new campaign for a specific product.
  """
  ...
  @doc """
  Updates an existing campaign for a specific product.
  """
  ...
  @doc """
  Deletes a campaign for a specific product (hard delete).
  """
  ...
  @doc """
  Gets a single campaign challenge by ID with product isolation.
  """
  ...
  @doc """
  Creates a new participant for a specific product.
  """
  ...
  @doc """
  Lists participants for a specific product with cursor-based pagination.
  ...
  @doc """
  Retrieves a participant by ID within a specific product.

  Returns the participant if found and belongs to the product, otherwise returns nil.
  """
  ...
  @doc """
  Updates a participant within a specific product.

  Returns {:ok, participant} if the participant exists and is updated successfully.
  Returns {:error, :not_found} if the participant doesn't exist or belongs to a different product.
  ...
  @doc """
  Deletes a participant within a specific product.
  ...
  @doc """
  Associates a participant with a campaign within the same product.

  Returns {:ok, campaign_participant} if the association is created successfully.
  Returns {:error, :product_mismatch} if the participant and campaign belong to different products.
  ...
  def associate_participant_with_campaign(product_id, participant_id, campaign_id) do
    # Validate participant belongs to product
    participant = get_participant(product_id, participant_id)

    # Validate campaign belongs to product
    campaign =
      Campaign
  ...
  @doc """
  Disassociates a participant from a campaign within the same product.

  Returns {:ok, campaign_participant} if the association is deleted successfully.
  Returns {:error, :not_found} if the association doesn't exist or belongs to a different product.
  ...
  @doc """
  Associates a participant with a challenge within the same product.

  Validates that:
  - Participant belongs to the product
  - Challenge belongs to the product (via its campaign)
  ...
  Returns {:error, :product_mismatch} if resources belong to different products.
  ...
  @doc """
  Disassociates a participant from a challenge within the same product.
