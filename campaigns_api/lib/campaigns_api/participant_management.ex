defmodule CampaignsApi.ParticipantManagement do
  @moduledoc """
  The ParticipantManagement context manages participant operations with tenant isolation.

  All operations require tenant_id parameter to ensure data isolation between tenants.
  Provides CRUD operations for participants, campaign associations, and challenge associations.
  """
  ...
  def disassociate_participant_from_challenge(tenant_id, participant_id, challenge_id) do
    participant_challenge =
      ...
      |> join(:inner, [pc], cc in CampaignsApi.CampaignManagement.CampaignChallenge,
